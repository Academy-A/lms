...
from tests.utils.srvmocker.models import BaseMockResponse
from tests.utils.srvmocker.serialization import JsonSerializer, Serializer
...
JsonResponse = partial(ContentResponse, serializer=JsonSerializer)
